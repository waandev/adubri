                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="form form-horizontal"
                                            ...
                                            <div class="form-body">
                                                            ...
                                                            <select name="role_id" id="role_id" class="form-control">
                                                                ...
                                                                @foreach ($roles as $role)
                                                                    <option value="{{ $role->id }}"
                                                                        {{ $user->role_user->role_id == $role->id ? 'selected' : '' }}>
                                                                        {{ $role->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-md-3 label-control" for="role_id">Status
                                                        <code style="color: red;">required</code></label>
                                                    <div class="col-md-9 mx-auto">
                                                        <div class="custom-file">
                                                            <select name="is_verified" id="is_verified"
                                                                ...
                                                                <option value="1"
                                                                    {{ old('is_verified', $user->verification->is_verified ?? 0) == 1 ? 'selected' : '' }}>
                                                                    Aktif</option>
                                                                <option value="0"
                                                                    {{ old('is_verified', $user->verification->is_verified ?? 0) == 0 ? 'selected' : '' }}>
                                                                    Non-Aktif</option>
                                                            </select>
                                                            @if ($errors->has('role_id'))
                                                                <p style="font-style: bold; color: red;">
